					...
					<div className=' tw-max-w-[1440px] tw-flex tw-gap-6 tw-flex-1'>
						...
						<div className='tw-basis-1/3'>
							<div className='tw-flex tw-flex-col tw-gap-6 tw-h-[87%]'>
								<ScanVisual scenario={scenario} isScanning={isScanning} onSideChange={handleRestart} onPause={handlePause} onRestart={handleRestart} shouldRestart={shouldRestart} />
								<ScanControls isScanning={isScanning} isInitialised={!!startClicks} onStart={handleStart} onPause={handlePause} onRestart={handleRestart} />
							</div>
						</div>
						<div className='tw-basis-1/3 tw-flex tw-flex-col tw-gap-4'>
							<Gyro />
							<HeartRate rate={scanData?.heart_rate} variability={scanData?.heart_rate_variability} />
